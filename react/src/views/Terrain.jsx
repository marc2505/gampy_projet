...
export default function Terrain() {
    ...
    useEffect(() => {
        ...
        console.log('NBADULTEFROMSTORAGE =')
        console.log(nbAdultesFromStorage)
        ...
        console.log('CALCUL => ')
        console.log(terrain.prix_nuitee+(nbAdultes-2)*terrain.prix_adulte_supp+nbAdo*terrain.prix_ado_supp+terrain.prix_taxe_sejour)*differenceInDays(new Date(valueEnd), new Date(valueStart))
    ...
    return (
        <div>
            ...
            >
                ...
                <Modal.Body>
                <p>Le nombre de gampeurs a atteind la capacité du terrain.</p>
                </Modal.Body>
                <Modal.Footer>
                <Button style={{ backgroundColor:'#25632d' }} onClick={handleClose}>
                    Close
                </Button>
                </Modal.Footer>
            </Modal>
                ...
                <div className="my-4 p-2" style={{ border:'1px solid #25632d' }}>
                    ...
                    <div className="row" style={{marginBottom:'30px'}}>
                        <div className="col-sm-6 text-center">
                            <h5 className='my-5'>
                                Nombre d'adultes : 
                                <button className='btn ms-3 me-2' style={{ background:'#25632d', color:'white' }} onClick={() => {
                                    const newNbAdultes = Math.max(2, nbAdultes - 1);
                                    checkCapacityAndSetValues(newNbAdultes, nbAdo);
                                }}>-</button>
                                {nbAdultes}
                                <button className='btn ms-2 me-3' style={{ background:'#25632d', color:'white' }}  onClick={() => {
                                    if (nbAdultes === nbAdultesMax) {
                                        handleShow(true)
                                    } else {
                                        setNbAdultes(prev => Math.min(nbAdultesMax, prev + 1))
                                    }
                                }}>+</button>
                            </h5>
                            <RangeSlider
                                ...
                                onInput={values => {
                                    ...
                                    if (fin + nbAdo > terrain.capacite_visiteurs) {
                                        setNbAdo(terrain.capacite_visiteurs - fin)
                                    }
                                    setNbAdultes(fin)
                                }}
                            />
                        ...
                        <div className="col-sm-6 text-center">
                            <h5 className='my-5'>
                                ...
                                <button className='btn ms-3 me-2' style={{ background:'#25632d', color:'white' }} onClick={() => {
                                    ...
                                    checkCapacityAndSetValues(nbAdultes, newNbAdo);
                                }}>-</button>
                                {nbAdo}
                                <button className='btn ms-2 me-3' style={{ background:'#25632d', color:'white' }} onClick={() => {
                                    if (nbAdo === nbAdoMax) {
                                        ...
                                        setNbAdo(prev => Math.min(nbAdoMax, prev + 1))
                                    }
                                }}>+</button>
                            </h5>
                            <RangeSlider
                                ...
                                onInput={values => {
                                    ...
                                    if (fin + nbAdultes > terrain.capacite_visiteurs) {
                                        setNbAdultes(terrain.capacite_visiteurs - fin)
                                        setShowModal(true)
                                    }
                                    setNbAdo(fin)
                                }}
                    ...
                    <div className="col-md-12" style={{ background:'lightgrey',paddingLeft:'10px',paddingRight:'10px',paddingBottom:'5px' }}>
                        ...
                        (
                            <div className='mb-3 text-center'>
                                <a 
                                    onClick={() => {
                                        localStorage.setItem('nbAdultes',nbAdultes)
                                        localStorage.setItem('nbAdo',nbAdo)
                                        localStorage.setItem('valueStart',valueStart)
                                        localStorage.setItem('valueEnd',valueEnd)
                                        navigate(`/login/terrain${terrain.id}?nbAdultes=${nbAdultes}&nbAdo=${nbAdo}`)
                                    }}
                                    className='btn'
                                    style={{ background:'#25632d', color:'white' }}
                                >
